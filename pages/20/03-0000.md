...
## <a name="motivation">Motivation and purpose</a>
...
<a name="fundamental-aspects">Fundamental SData aspects</a>
...
*  [SData URL](#sdata-url)
*  [SData payload formatting](#payload-elements)
*  [Requesting content formats](#requesting-content)
*  [Operations](#operations)
*  [Authorization](#authorization)
*  [Status and error conditions](#error-codes)
...
## <a name="payload-elements">SData payload elements</a>
...
### <a name="feed-level">Feed level</a>
...
#### <a name="protocol-defined-elements">Protocol-defined elements</a>
...
#### <a name="feed-level-links">Links</a>
...
### <a name="entry-level">Entry level</a>
...
#### <a name="entry-level-links">Links</a>
...
### <a name="property-level">Property level</a>
...
## <a name="requesting-content">Requesting content by means of media type negotiation</a>
...
## <a name="error-codes">Status and error codes</a>
...
delivery teams.   
<a name="3">3</a>. These elements are hardly any use to us in practical terms