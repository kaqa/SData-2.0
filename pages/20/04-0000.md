...
## <a name="json-formalism">Introduction to the JSON formalism</a>
...
## <a name="native-objects">Formatting native objects in JSON</a>
...
## <a name="json-content">Requesting JSON formatted SData content</a>
...
## <a name="json-responses">JSON responses</a>
...
### <a name="json-entries">JSON entries</a>
...
### <a name="json-feeds">JSON feeds</a>
...
<table class="left">
    ...
    <tr>
        <th><a name="baseurl">$baseUrl</a></th><td>URL leading to the resource kind level of an application. The URL MUST end 
in a "/"<br />
...
### <a name="json-diagnosis">JSON diagnosis</a>
...
### <a name="json-tracking">JSON tracking</a>
...
## <a name="atom-xml">A note to SData ATOM+xml users</a>
