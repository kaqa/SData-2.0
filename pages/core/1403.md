...
<pre>[http://www.example.com/sdata/$system/registry/-/endpoints](http://www.example.com/$system/endpoints)
</pre>
...
contracts&nbsp; (see [Intermediate URLs](2.9 Intermediate URLs "2.9 Intermediate URLs")).
...
sets&nbsp; (see [Intermediate URLs](2.9 Intermediate URLs "2.9 Intermediate URLs")).
...
Language](2.12 Query Language "2.12  Query Language")&nbsp;section). So, for example, a consumer should be able to request the
