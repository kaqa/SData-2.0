...
0 is recommended value. See [Update Payloads section](9.2 Update Payloads "9.2 Update Payloads")
for an explanation.
...
section](3.6 Simple List Extensions) for details.
...
[query
parameters](2.11 Query Parameters). The <tt>precedence</tt> query parameter allows a service
...
[Controlling Payload section](6.5 Query Payload Control "6.5 Query Payload Control") for details.
...
[Relationship Definition section](4.4 Relationship Definitions "4.4 Relationship Definitions") for details.
...
a reference relationship (see [Relationship Definition
section](4.4 Relationship Definitions "4.4 Relationship Definitions") for details).&nbsp; The <tt>isCollection</tt> attribute is <tt>true</tt>
