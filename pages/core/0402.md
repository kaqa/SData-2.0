...
There is an overlap between the <tt>canGet</tt>,
...
rules can further restrict the operations&nbsp;a&nbsp;user can&nbsp;perform
...
SData providers MUST return a schema and MUST follow the rules
above.
