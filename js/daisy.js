...
function showDocumentInfoPopup(urlPrefix, docName, docId, branch, branchId, language, languageId, version, versionCount,
                               versionCreated, versionState, versionStateModified, docOwner, documentPath, documentTypeLabel) {
    ...
    url += "&typeLabel=" + encodeURIComponent(documentTypeLabel);
